...
public class JsonParser {
    ...
    private static void extraireDonneesDepuisFichierJSONVersAlbum( ArrayList < Album > albums, JSONArray donneesContenuDansJSON ){
        ...
        for ( int i = 0; i < donneesContenuDansJSON.size(); ++i ) {
            ...
            JSONObject album = donneesContenuDansJSON.getJSONObject( i );
     ...
     */
    public static ArrayList < Album > jsonFileToAlbum ( String nomFichierJSON ) throws IOException {
        ...
        // Parse la chaîne JSON en un objet JSON.
        ...
        JSONArray donneesContenuDansJSON = objet.getJSONArray( "collection" );
