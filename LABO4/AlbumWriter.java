...
public class AlbumWriter {
    ...
    public static void main( String [] args ) {
        ...
        try {
            ...
            // Tente de sauvegarder les données JSON dans un fichier avec une indentation de 2 espaces.
            DiskFile.saveStringIntoFile( "nouveau-fichier-JSON.json", collection.toString( 2 ) );

        } catch ( IOException e ) {

            // En cas d'erreur d'entrée/sortie lors de la sauvegarde, affiche l'erreur.
            e.printStackTrace();
